...
SKILLS = ["Javascript", "Node.js", "Nginx", "AWS", "EC2", "S3", "DynamoDB", "Docker", "React.js", "Vue.Js", "Python", "Django", "Flask", "Docker", "Docker Compose", "Kubernetes"]
...
class CandidateFactory(factory.django.DjangoModelFactory):
    class Meta:
        ...
        django_get_or_create = ('first_name', 'last_name', 'primary_role', 'experience', 'bio', 'email', 'phone', 'adress', 'city', 'state', 'zipcode', 'country', 'projects', 'skills', 'status')
